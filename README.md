...
| :-------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------- |
| [**ClinicalTrials.gov MCP Server**](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)            | An MCP (Model Context Protocol) server providing a robust, developer-friendly interface to the official ClinicalTrials.gov v2 API. Enables LLMs and AI agents to search, retrieve, and analyze clinical study data programmatically. | Actively using this template.                                                                                                            |
