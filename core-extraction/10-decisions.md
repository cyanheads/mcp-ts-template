...
| 2026-03-09 | Fixed `@hono/mcp` and `diff` dep placement | Plan review | `@hono/mcp` misplaced in devDeps. `diff` duplicated in both deps and devDeps — remove devDeps duplicate. |
