...
URL Source: https://modelcontextprotocol.io/extensions/apps/overview

Markdown Content:
# MCP Apps - Model Context Protocol

[Skip to main content](https://modelcontextprotocol.io/extensions/apps/overview#content-area)
...
*   [Why not just build a web app?](https://modelcontextprotocol.io/extensions/apps/overview#why-not-just-build-a-web-app)
*   [How MCP Apps work](https://modelcontextprotocol.io/extensions/apps/overview#how-mcp-apps-work)
*   [When to use MCP Apps](https://modelcontextprotocol.io/extensions/apps/overview#when-to-use-mcp-apps)
*   [Security model](https://modelcontextprotocol.io/extensions/apps/overview#security-model)
*   [Framework support](https://modelcontextprotocol.io/extensions/apps/overview#framework-support)
*   [Client support](https://modelcontextprotocol.io/extensions/apps/overview#client-support)
*   [Examples](https://modelcontextprotocol.io/extensions/apps/overview#examples)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#why-not-just-build-a-web-app)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#how-mcp-apps-work)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#when-to-use-mcp-apps)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#security-model)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#framework-support)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#client-support)
...
## [​](https://modelcontextprotocol.io/extensions/apps/overview#examples)
...
[Extension Support Matrix](https://modelcontextprotocol.io/extensions/client-matrix)[Build an MCP App](https://modelcontextprotocol.io/extensions/apps/build)
