...
URL Source: https://modelcontextprotocol.io/extensions/overview

Markdown Content:
# Extensions Overview - Model Context Protocol

[Skip to main content](https://modelcontextprotocol.io/extensions/overview#content-area)
...
*   [MCP Extensions](https://modelcontextprotocol.io/extensions/overview#mcp-extensions)
*   [Official Extension Repositories](https://modelcontextprotocol.io/extensions/overview#official-extension-repositories)
*   [MCP Authorization Extensions](https://modelcontextprotocol.io/extensions/overview#mcp-authorization-extensions)
*   [MCP Apps](https://modelcontextprotocol.io/extensions/overview#mcp-apps)
*   [Experimental Extensions](https://modelcontextprotocol.io/extensions/overview#experimental-extensions)
*   [Ground Rules](https://modelcontextprotocol.io/extensions/overview#ground-rules)
*   [Graduation to Official Status](https://modelcontextprotocol.io/extensions/overview#graduation-to-official-status)
*   [Creating Extensions](https://modelcontextprotocol.io/extensions/overview#creating-extensions)
*   [Requirements](https://modelcontextprotocol.io/extensions/overview#requirements)
*   [SDK Implementation](https://modelcontextprotocol.io/extensions/overview#sdk-implementation)
*   [Evolution](https://modelcontextprotocol.io/extensions/overview#evolution)
*   [Negotiation](https://modelcontextprotocol.io/extensions/overview#negotiation)
*   [Client Capabilities](https://modelcontextprotocol.io/extensions/overview#client-capabilities)
*   [Server Capabilities](https://modelcontextprotocol.io/extensions/overview#server-capabilities)
*   [Graceful Degradation](https://modelcontextprotocol.io/extensions/overview#graceful-degradation)
...
# [​](https://modelcontextprotocol.io/extensions/overview#mcp-extensions)
...
## [​](https://modelcontextprotocol.io/extensions/overview#official-extension-repositories)
...
### [​](https://modelcontextprotocol.io/extensions/overview#mcp-authorization-extensions)
...
| --- | --- |
| [OAuth Client Credentials](https://modelcontextprotocol.io/extensions/auth/oauth-client-credentials) | OAuth 2.0 client credentials flow for machine-to-machine authentication. |
| [Enterprise-Managed Authorization](https://modelcontextprotocol.io/extensions/auth/enterprise-managed-authorization) | Framework for enterprise environments requiring centralized access control. |

### [​](https://modelcontextprotocol.io/extensions/overview#mcp-apps)
...
| Extension | Description |
| --- | --- |
| [MCP Apps](https://modelcontextprotocol.io/extensions/apps/overview) | Allows MCP Servers to display interactive UI elements (charts, forms, video players) inline within conversations |

To get started building MCP Apps, see the [quickstart guide](https://modelcontextprotocol.io/extensions/apps/build#getting-started) or read the full [MCP Apps documentation](https://apps.extensions.modelcontextprotocol.io/api/documents/Quickstart.html).
## [​](https://modelcontextprotocol.io/extensions/overview#experimental-extensions)

Experimental Extensions

Experimental extensions provide an incubation pathway for [Working Groups and Interest Groups](https://modelcontextprotocol.io/community/working-interest-groups) to prototype ideas and collaborate on extension concepts before formal SEP submission.Experimental extension repositories live within the MCP GitHub organization with the `experimental-ext-` prefix (e.g., `experimental-ext-interceptors`).
### [​](https://modelcontextprotocol.io/extensions/overview#ground-rules)
...
*   [Core Maintainers](https://modelcontextprotocol.io/community/contributor-ladder#core-maintainer) retain oversight of experimental extension repositories, including the ability to archive or remove them

### [​](https://modelcontextprotocol.io/extensions/overview#graduation-to-official-status)
...
## [​](https://modelcontextprotocol.io/extensions/overview#creating-extensions)

Creating Extensions

The lifecycle for official extensions follows a SEP-based process. For full details, see [SEP-2133: Extensions](https://modelcontextprotocol.io/seps/2133-extensions).
1.   **Propose**: Create a SEP in the main MCP repository using the [standard SEP guidelines](https://modelcontextprotocol.io/community/sep-guidelines) with type **Extensions Track**.
...
3.   **Review**: [Core Maintainers](https://modelcontextprotocol.io/community/contributor-ladder#core-maintainer) review the SEP and have final authority over inclusion.
...
### [​](https://modelcontextprotocol.io/extensions/overview#requirements)
...
### [​](https://modelcontextprotocol.io/extensions/overview#sdk-implementation)
...
### [​](https://modelcontextprotocol.io/extensions/overview#evolution)
...
### [​](https://modelcontextprotocol.io/extensions/overview#client-capabilities)
...
### [​](https://modelcontextprotocol.io/extensions/overview#server-capabilities)
...
### [​](https://modelcontextprotocol.io/extensions/overview#graceful-degradation)
