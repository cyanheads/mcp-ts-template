/**
 * @fileoverview Speech service factory and exports.
...
import type { ISpeechProvider, SpeechProviderConfig } from './types.js';
...
export { supportsTTS, supportsSTT } from './types.js';
